...
/** Downloads and extracts the latest Pterodactyl panel release. */
...
/** Runs the Laravel install sequence: Composer, key generation, environment setup, migrations. */
...
/** Creates admin users via the Laravel artisan command for each user in the config. */
...
/** Reads the APP_KEY from the panel `.env` after installation. */
